<nav class="modulos">
    ...
    <div class="modulo verde">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=tratamento_erro&file=desafio_intdiv_teste">Desafio Intdiv Teste</a></li>
    ...
    <div class="modulo azul-escuro">
        ...
        <ul>
            ...
            <li><a href="exercicio.php?dir=classes_objetos&file=data">Data</a></li>
